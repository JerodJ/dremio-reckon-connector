...
@SourceType(value = "ReckonARP", label = "Reckon",uiConfig = "reckon-layout.json")
public class ReckonConf extends AbstractArpConf<ReckonConf> {
  private static final String ARP_FILENAME = "arp/implementation/reckon-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.reckon.ReckonDriver";
